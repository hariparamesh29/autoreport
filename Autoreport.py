...
# --- GEMINI API SETUP ---
GEMINI_API_KEY = "AIzaSyAEZnp0jG8nWkiw3iPZ6Zf4DEDMzMTb5QI"  # 🔒 Never expose this publicly

if GEMINI_API_KEY:
    genai.configure(api_key=GEMINI_API_KEY)
    model = genai.GenerativeModel("gemini-2.0-flash")  # or "gemini-pro" depending on availability
...
if uploaded_file and GEMINI_API_KEY:
    ...
    if not GEMINI_API_KEY:
        st.warning("Gemini API key is missing. Please add your key.")
